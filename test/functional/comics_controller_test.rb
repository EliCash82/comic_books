...
class ComicsControllerTest < ActionController::TestCase
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post :create, comic: { issue: @comic.issue, publisher: @comic.publisher, synopsis: @comic.synopsis, title: @comic.title, year: @comic.year }
    end
  ...
  test "should update comic" do
    put :update, id: @comic, comic: { issue: @comic.issue, publisher: @comic.publisher, synopsis: @comic.synopsis, title: @comic.title, year: @comic.year }
    assert_redirected_to comic_path(assigns(:comic))
  end
